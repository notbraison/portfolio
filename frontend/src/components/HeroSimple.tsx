        ...
        >
          ...
          >
            ...
            <motion.button
              ...
              whileTap={{ scale: 0.95 }}
              className="px-8 py-4 bg-white/10 backdrop-blur-md text-gray-800 dark:text-white rounded-lg font-semibold text-lg border border-white/20 hover:bg-white/20 transition-all duration-300"
            >
              Get In Touch
            </motion.button>
          </motion.div>
